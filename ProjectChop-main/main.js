...
function placeOrder() {
    ...
    const addsCustomer = document.getElementById("AddrInput").value;

    if (customerName &&  phoneNumber && addsCustomer) {
        const orders = JSON.parse(localStorage.getItem("orders")) || [];
        orders.push({ menu: menuName, name: customerName, phone: phoneNumber,  address: addsCustomer});
        ...
        document.getElementById("addsCustomer").value = "";
